...
if(isset($_POST['Submit'])) {	
	...
	mysql_query("INSERT INTO products7(shopname,floorno,shopno,owner,contact) VALUES('$sname','$flo_no','$shop_no','$owner','$contact')");
					...
					<div id="page" class="container">
						<div class="row">
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<header class="major">
										<h2>Add Location for KIDSCORNER</h2>
										
										<form action="add_kids.php" method="post" name="form1">
					<div class="row half">
