...
{	$pid = $_POST['pid'];
	...
	// checking empty fields
		...
		//updating the table
mysql_query("UPDATE products7 SET offerfor='$of_for',discounton='$dis_on',discountper='$dis_per',offerfrom='$of_from',offerupto='$of_upto' WHERE pid=$pid");
		
		//redirectig to the display page. In our case, it is index.php
header("Location: view_kids.php");
	}
?>
<?php
include_once("config.php");
...
$result = mysql_query("SELECT * FROM products7 WHERE pid=$pid");
...
while($res = mysql_fetch_array($result))
{
	$sname = $res['shopname'];
	$of_for = $res['offerfor'];
	$dis_on = $res['discounton'];
	$cre_at = $res['created_at'];
	$up_at = $res['updated_at'];
	$dis_per = $res['discountper'];
					...
					<div id="page" class="container">
						<div class="row">
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<header class="major">
										<h2>KIDSCORNER OFFER</h2>
										<form name="form1" method="post" action="edit_kids.php">
					<div class="row half">
