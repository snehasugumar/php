...
{	$pid = $_POST['pid'];
	...
	// checking empty fields
		...
		//updating the table
mysql_query("UPDATE products6 SET offerfor='$of_for',discounton='$dis_on',discountper='$dis_per',offerfrom='$of_from',offerupto='$of_upto' WHERE pid=$pid");
...
$result = mysql_query("SELECT * FROM products6 WHERE pid=$pid");
						...
						<div class="row">
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<header class="major">
										<h2>CLOTH OFFER</h2>
										<form name="form1" method="post" action="edit_dress.php">
					<div class="row half">
