...
$result = mysql_query("SELECT * FROM products4 ORDER BY pid DESC");
?>
...
border-right: 2px solid #319AD4;
					...
					<div id="header" class="skel-panels-fixed">
						...
						<nav id="nav">
							<ul>
								...
								<li><a href="add_medicine.php">Add New Shop Details</a></li>
			...
			<div style="width:800px;height:500px;background-color:#f2c0d3;margin-left:100px;">
				...
				<div class="row half">
							<div style="margin-left:60px;width:250px;margin-top:10px;font-size:20px;">
								 <h1 style="font-size:30px;margin-left:50px;margin-Bottom:50px;margin-top:30px;">AddingLocationForAccessories</h1>
							</div>
						</div>
	...
	while($res = mysql_fetch_array($result)) { 		
		...
		echo "<td><a href=\"edit_medicine.php?pid=$res[pid]\">Add Offers</a> | <a href=\"delete_medicine.php?pid=$res[pid]\" onClick=\"return confirm('Are you sure you want to delete?')\">Remove</a></td>";		
	}
	?>
