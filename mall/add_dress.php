...
if(isset($_POST['Submit'])) {	
	...
	mysql_query("INSERT INTO products6(shopname,floorno,shopno,owner,contact) VALUES('$sname','$flo_no','$shop_no','$owner','$contact')");
					...
					<div id="page" class="container">
						<div class="row">
									...
									<div class="row half">
										<section class="6u">
											<ul  style="margin-top:90px;">
												<li><img src="images/pic13.jpg" height="500"alt=""></li>
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<header class="major">
										<h2>Add Location for ClothinShops</h2>
										<form action="add_dress.php" method="post" name="form1">
					<div class="row half">
