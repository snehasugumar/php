...
{	$pid = $_POST['pid'];
	...
	// checking empty fields
		...
		//updating the table
mysql_query("UPDATE products5 SET offerfor='$of_for',discounton='$dis_on',discountper='$dis_per',offerfrom='$of_from',offerupto='$of_upto' WHERE pid=$pid");
					...
					<div id="page" class="container">
						...
						<div class="row half">
							...
							<div id="sidebar" class="4u">
								<section>
									<header class="major">
										<h2>FOODCOURT OFFER</h2>
									</header>
									<div class="row half">
										<section class="6u">
											<ul class="default">
												<li><img src="images/ig.jpg" height="500"alt=""></li>
											</ul>
										</section>
